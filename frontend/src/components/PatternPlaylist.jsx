...
export default function PatternPlaylist({ patterns, selectedPatternId, isEditorOpen, onSelect, onCreate, onRename, onDelete, onExtend, readOnly = false }) {
  ...
  return (
    <aside className="patternPlaylist" aria-label="Pattern playlist">
      <div className="playlistHeader">
        ...
        {!readOnly && <button className="addPatternButton" type="button" onClick={onCreate} aria-label="Create pattern">+</button>}
      </div>
